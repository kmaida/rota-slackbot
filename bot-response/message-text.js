...
const msgText = {
  ...
  staffError: (rotation) => {
    return ':shrug: I couldn\'t save staff for a "' + rotation + '" rotation because it does not exist. To create this rotation, first tell me `@rota new "' + rotation + '" [description]`, _then_ set up staffing.';
  },
  ...
  resetStaffError: (rotation) => {
    return ':shrug: I couldn\'t reset the staff list for a "' + rotation + '" rotation because it does not exist. To create this rotation, first tell me `@rota new "' + rotation + '" [description]`. It will initialize with no staff by default.';
  },
  ...
  aboutError: (rotation) => {
    return ':shrug: I couldn\'t get any info about a "' + rotation + '" rotation because it does not exist. To create it, use `@rota new "' + rotation + '" [description]`.';
  },
  ...
  assignError: (rotation) => {
    return ':shrug: I couldn\'t complete this assignment because a "' + rotation + '" rotation does not exist. To create it, use `@rota new "' + rotation + '" [description]`.';
  },
  listReport: (list) => {
    let msgStr = '';
  ...
  whoError: (rotation) => {
    return ':shrug: I couldn\'t find any on-call user because a "' + rotation + '" rotation does not exist. To create it, use `@rota new "' + rotation + '" [description]`. You can then assign someone using `@rota "' + rotation + '" assign [@user] [optional handoff message]`.';
  },
  ...
  unassignError: (rotation) => {
    return ':shrug: I couldn\'t clear this assignment because a "' + rotation + '" rotation does not exist. To create it, use `@rota new "' + rotation + '" [description]`.';
  },
  ...
  msgError: (rotation) => {
    return ':shrug: I couldn\'t tell anyone about the message because a "' + rotation + '" rotation does not exist. To create it, use `@rota new "' + rotation + '" [description]`.';
  },
  didntUnderstand: () => {
